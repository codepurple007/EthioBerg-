...
function Wordmark() {
  return (
    <Link href="/" className="group inline-flex items-center gap-2.5" aria-label="EthioBerg home">
      <svg
        viewBox="0 0 44 44"
        aria-hidden="true"
      ...
      <header className="fixed inset-x-0 top-0 z-50 bg-[#061B49] text-white shadow-lg shadow-blue-950/10">
        ...
        {menuOpen && (
          <nav className="border-t border-blue-900 bg-[#041538] px-5 py-4 lg:hidden">
            ...
            <Link href="/auth/signin" className="mt-4 flex h-11 items-center justify-center bg-blue-600 text-sm font-bold">
